...
#
# Created: Mon Nov 30 19:44:43 2015
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.radio_use_file_matrices.setGeometry(QtCore.QRect(0, 450, 261, 22))
        self.radio_use_file_matrices.setObjectName("radio_use_file_matrices")
        self.groupBox_2 = QtGui.QGroupBox(self.groupBox_5)
        self.groupBox_2.setGeometry(QtCore.QRect(-20, 40, 481, 401))
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(20, 480, 461, 61))
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(10, 540, 421, 71))
        self.formLayoutWidget.setObjectName("formLayoutWidget")
        self.formLayout_3 = QtGui.QFormLayout(self.formLayoutWidget)
        self.formLayout_3.setContentsMargins(0, 0, 0, 0)
        self.formLayout_3.setObjectName("formLayout_3")
        self.rgb_time_file_edit = QtGui.QLineEdit(self.formLayoutWidget)
        self.rgb_time_file_edit.setReadOnly(True)
        self.rgb_time_file_edit.setObjectName("rgb_time_file_edit")
        self.formLayout_3.setWidget(0, QtGui.QFormLayout.FieldRole, self.rgb_time_file_edit)
        self.tv_time_file_edit = QtGui.QLineEdit(self.formLayoutWidget)
        self.tv_time_file_edit.setReadOnly(True)
        self.tv_time_file_edit.setObjectName("tv_time_file_edit")
        self.formLayout_3.setWidget(1, QtGui.QFormLayout.FieldRole, self.tv_time_file_edit)
        self.rgb_time_button = QtGui.QPushButton(self.formLayoutWidget)
        self.rgb_time_button.setObjectName("rgb_time_button")
        self.formLayout_3.setWidget(0, QtGui.QFormLayout.LabelRole, self.rgb_time_button)
        self.tv_time_button = QtGui.QPushButton(self.formLayoutWidget)
        self.tv_time_button.setObjectName("tv_time_button")
        self.formLayout_3.setWidget(1, QtGui.QFormLayout.LabelRole, self.tv_time_button)
        ...
        QtCore.QObject.connect(self.rgb_time_button, QtCore.SIGNAL("clicked()"), Dialog.on_select_rgb_time_file_clicked)
        QtCore.QObject.connect(self.tv_time_button, QtCore.SIGNAL("clicked()"), Dialog.on_select_tv_time_file_clicked)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.rgb_time_button.setText(QtGui.QApplication.translate("Dialog", "Select camera-1 time file", None, QtGui.QApplication.UnicodeUTF8))
        self.tv_time_button.setText(QtGui.QApplication.translate("Dialog", "Select camera-2 time file", None, QtGui.QApplication.UnicodeUTF8))
